                ...
                if(requestBigDataResult.getStatus()) {
                    ...
                    switch (requestBigData.getTypetraitement()) {
                        ...
                        case 2:
                            ...
                            ligneList = dateStr + " : " + requestBigDataResult.getValue("REGCORR_GLOBAL_TITRE");
                            controleurList.add(ligneList);
                            break;
                        case 3:
                            dateStr = sdf.format(requestBigDataResult.getValue("ANOVA2_DATE"));
                            ligneList = dateStr + " : " + requestBigDataResult.getValue("ANOVA2_GLOBAL_TITRE");
                            controleurList.add(ligneList);
                            break;
                    }
                }
    ...
    protected void sendEmail() {
        ...
        switch (requestBigData.getTypetraitement()) {
            ...
            case 2:
                ...
                emailIntent.putExtra(Intent.EXTRA_TEXT, "Formule : " + "\n" + (String)requestBigDataResult.getValue("REGGCOR_GLOBAL_TEXT")+ "\n"
