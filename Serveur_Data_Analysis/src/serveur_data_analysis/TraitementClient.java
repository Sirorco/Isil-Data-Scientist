...
public class TraitementClient implements Runnable {
    ...
    //variables de communications avec le client pour le login
    private BaseRequest requeteBaseClient = null;
...
// <editor-fold desc="Login Answers">
    void answerLoginInitiator(){
...
// <editor-fold desc="BigData Answers">    
    void answerBigDataResult(){
        ...
        switch(requeteClient.getTypetraitement()){
            case RequestDoBigData.CAH :
                cah.getDMCAH();
            ...
            case RequestDoBigData.REG_CORR:
                regCor.getDMRegCor();
            ...
            default:
                reponseClient.setStatus(false);
                System.err.println("Type de requete de Big-Data result inconnue");
                mF.getjTextFieldLogServeur().setText("Thread : " + this.toString() + " Erreur envoi de Big-Data Result - Type inconnu !");
                break;
        }
    }
    
    void answerDoBigData(){
        reponseClient = new RequestBigDataResult();
        RequestDoBigData requeteClient = (RequestDoBigData) requeteBaseClient;
        ...
        switch(requeteClient.getTypetraitement()){
            ...
            case RequestDoBigData.ANOVA:anova2.refreshAnova();
                ((RequestBigDataResult)reponseClient).setData(anova2.getDataset());
                reponseClient.setStatus(true);
            ...
            default :
                reponseClient.setStatus(false);
                System.err.println("Type de requete de Do Big-Data  inconnue");
                mF.getjTextFieldLogServeur().setText("Thread : " + this.toString() + " Erreur envoi de Do Big-Data - Type inconnu !");
                break;   
        }
}
// </editor-fold>    
    ...
    public void run() {
        ...
        try {
            while ((requeteBaseClient = (BaseRequest) ois.readObject()).getId() != BaseRequest.LOGOUT) {
                ...
                switch(requeteBaseClient.getId()){
                    case BaseRequest.LOGIN_INITIATOR :
                        answerLoginInitiator();
                        break;
                    
                    case BaseRequest.LOGIN_EID :
                        answerLoginEID();
                        break;
                    
                    case BaseRequest.LOGIN_CARTES_A_PUCES :
                        answerLoginCarteAPuce();
                        break;
                        
                    case BaseRequest.LOGIN_OTP :
                        answerLoginOTP();
                        break;
                        
                    case BaseRequest.LOGIN_WEB :
                        answerLoginWEB();
                        break;
                        
                    case BaseRequest.LOGOUT :
                        
                        break;
                        
                    case BaseRequest.BIG_DATA_RESULT : 
                        answerBigDataResult();
                        break;
                        
                    case BaseRequest.DO_BIG_DATA :
                        answerDoBigData();
                        break;
                    
                    default :
                        mF.getjTextFieldLogServeur().setText("Thread : " + this.toString() + " Erreur requete inconnue !");
                        System.err.println("Requete non inconnue");
                        break;
                }
// <editor-fold desc="Ancienne suite de if pas trop propre." defaultstate="collapsed">
/*
