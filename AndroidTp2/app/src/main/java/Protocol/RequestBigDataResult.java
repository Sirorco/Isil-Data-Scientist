...
public class RequestBigDataResult extends BaseRequest {
    ...
    public static String  REGCORR_GLOBAL_TITRE = "REGCORR_GLOBAL_TITRE"; // Titre globale du graphique REGCORR
    ...
    public static String  ANOVA2_GLOBAL_TITRE = "ANOVA2_GLOBAL_TITRE"; // Titre globale du graphique ANOVA2 
    ...
    public static String  ACM_GLOBAL_TITRE = "ACM_GLOBAL_TITRE"; // Titre globale du graphique ACM 
